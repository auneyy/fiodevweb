            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/5 border-b border-white/10">
                  ...
                  <th className="px-4 py-3 text-xs uppercase tracking-wider text-gray-400 font-semibold">Tipe</th>
                  <th className="px-4 py-3 text-xs uppercase tracking-wider text-gray-400 font-semibold">Cloud ID</th>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((log) => (
                    <tr key={log.id} className="hover:bg-white/5 border-b border-white/5 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm font-mono text-gray-300">{log.cloud_id}</td>
